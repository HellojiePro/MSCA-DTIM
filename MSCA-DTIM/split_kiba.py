...
dir_input = "/stu-3031/MMDG_Data/datasets/datasets/Kiba/data_split/"
...
for j in range(len(train_list)):
    if train_list[j] >= 116350: continue
    a += 1
...
for j in range(len(test_list)):
    if test_list[j] >= 116350: continue
    b += 1
...
np.save(os.path.join(DATA_ROOT, "Kiba", "train", "molecule_words.npy"), molecule_words_train)
np.save(os.path.join(DATA_ROOT, "Kiba", "train", "molecule_atoms.npy"), molecule_atoms_train)
np.save(os.path.join(DATA_ROOT, "Kiba", "train", "molecule_adjs.npy"), molecule_adjs_train)
np.save(os.path.join(DATA_ROOT, "Kiba", "train", "proteins.npy"), proteins_train)
np.save(os.path.join(DATA_ROOT, "Kiba", "train", "interactions.npy"), affinity_train)
np.save(os.path.join(DATA_ROOT, "Kiba", "train", "sequences.npy"), sequences_train)
np.save(os.path.join(DATA_ROOT, "Kiba", "train", "smiles.npy"), smiles_train)
...
np.save(os.path.join(DATA_ROOT, "Kiba", "test", "molecule_words.npy"), molecule_words_test)
np.save(os.path.join(DATA_ROOT, "Kiba", "test", "molecule_atoms.npy"), molecule_atoms_test)
np.save(os.path.join(DATA_ROOT, "Kiba", "test", "molecule_adjs.npy"), molecule_adjs_test)
np.save(os.path.join(DATA_ROOT, "Kiba", "test", "proteins.npy"), proteins_test)
np.save(os.path.join(DATA_ROOT, "Kiba", "test", "interactions.npy"), affinity_test)
np.save(os.path.join(DATA_ROOT, "Kiba", "test", "sequences.npy"), sequences_test)
np.save(os.path.join(DATA_ROOT, "Kiba", "test", "smiles.npy"), smiles_test)
